<div class="modal fade" id="fin_adenda" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="procesos/agregar_radenda.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="selectSm" class=" form-control-label">Contrato</label></div>
                                            <div class="col-12 col-md-9"><select name="radenda" id="radenda" class="form-control-sm form-control">
                                                    <?php
                                                        ...
                                                        // echo "<option value=".$rw["id_contrato"]."> CAS N° ".$rw["nro_contrato"]."</option> ";
                                                            $sql_c="SELECT * FROM cas_adenda WHERE id_contrato=$id_contrato";
                                                            $r=pg_query($con,$sql_c);
                                                            while ($ren=pg_fetch_array($r)) {
                                                                # code...
                                                            echo "<option value=".$ren["id_adenda"]."> ADENDA N° ".$ren["nro_adenda"]."</option> ";
                                                            }
                                                        } 
                                                    ?>
                                                </select>
