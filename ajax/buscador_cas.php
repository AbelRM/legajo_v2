				...
				while ($row=pg_fetch_array($query)){
					...
					<tr>
						...
						<form method="POST" action="cas_registro.php">
								...
								<button type="submit" class="btn btn-info btn-sm" ><i class="fa fa-mail-forward"></i>&nbsp; Visualizar</button><p></p>

							</form>
							
							<form method="POST" action="cas_modificar.php">
								<input type="hidden" value="<?php echo $id_cas; ?>" name="id">
								<button type="submit" class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o"> </i>&nbsp; Modificar</button>	
								</form></td>
							</td>
						</td>
